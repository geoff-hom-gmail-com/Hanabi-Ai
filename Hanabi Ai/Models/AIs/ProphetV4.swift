...
///
/// 1) Plays 1st playable; 2) discards unscorable card; 3) discards duplicate among hands; 4) discards future duplicate; 5) if another player can do any of those, clues; 6) discards deck duplicate that will take longest to play; 7) if other players have only singletons, avoids clue loop: discards singleton that will take longest to play; 8) clues.
/// Stats from 10,000 games: Avg. 24.88 (18–25).
struct ProphetV4: AI {
    /// The AI's name.
    let name = "Prophet v4"
    
    /// Summary of the AI.
    let description = "1) plays 1st playable; 2) discards unscorable card; 3) discards duplicate among hands; 4) discards future duplicate; 5) if another player can do any of those, clues; 6) discards deck duplicate that will take longest to play; 7) if other players have only singletons, avoids clue loop: discards singleton that will take longest to play; 8) clues"
