...
///
/// Plays 1st playable; else, discards scored card; else, discards duplicate card in hand; else, discards duplicate card in deck; else, clues; else, discards highest card.
/// Stats from 10,000 games: Avg. 24.68 (17–25).
struct PlayableV4: AI {
    /// The AI's name.
    let name = "Playable v4"
    
    /// Summary of the AI.
    let description = "plays 1st playable; else, discards scored card; else, discards duplicate card in hand; else, discards duplicate card in deck; else, clues; else, discards highest card"
